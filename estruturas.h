...
int pontoSelecionado, linhaSelecionada = 0, poligonoSelecionado = 0;
char pickObjeto[3];
GLint pontoFimX, pontoFimY;
int transladarAtivacao = 0, transladarPonto = 0, transladarLinha = 0, transladarPoligono = 0, rotacaoAtivacao = 0, escalaAtivacao = 0;
Poligono poligonoAuxiliar;
Ponto pontoAuxiliar;
Reta retaAuxiliar;
int incrementaRotacao = 1, incrementaEscala = 1;
